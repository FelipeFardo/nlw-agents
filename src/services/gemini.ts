...
export async function transcribeAudio(audioAsBase64: string, mimeType: string) {
  const response = await gemini.models.generateContent({
    ...
    contents: [
      {
        text: 'Transcreva o áudio para o português do Brasil. Seja preciso e natural na transrição. Mantenha a pontuação adequada e divida o texto em parágrafo quando for apropriado',
      },
      {
        inlineData: {
          mimeType,
